...
public interface RequirementDao {
	...
	@Select({ "select ", SELECT_FIELDS, " from ", TABLE_NAME, " where  publish_id=#{publishId} and business_id=#{businessId}" })
	List<Requirement> selectRequirementByBusiness(@Param("publishId") int publishId, @Param("businessId") int businessId);
}
